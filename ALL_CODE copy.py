...
#mse_log = np.mean((pred_log - y_test_f_log)**2)
...
# # Sort the log-transformed values to identify outliers along axis 0 (values)
# sorted_log = np.sort(X_test_log, axis=0)
